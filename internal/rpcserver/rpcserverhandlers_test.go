...
func TestHandleGetMixpoolInfo(t *testing.T) {
	...
	utxo1 := wire.OutPoint{Hash: chainhash.Hash{0x01}, Index: 0}
	utxo2 := wire.OutPoint{Hash: chainhash.Hash{0x02}, Index: 3}
	...
	pr1.WriteHash(blake256.New())
	pr2.WriteHash(blake256.New())
